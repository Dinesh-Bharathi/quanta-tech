 ...
 */
export const hasReadPermission = (permissions?: Permission): boolean => {
 ...
 */
export const filterNavItem = (item: NavItem): NavItem | null => {
 ...
 */
export const sectionHasAccessibleItems = (section: NavSection): boolean => {
 ...
 */
export const countAccessibleItems = (navigation: NavSection[]): number => {
  let count = 0;
 ...
 */
export const getFirstAccessibleUrl = (
  navigation: NavSection[]
): string | null => {
 ...
 */
export const getAllAccessibleUrls = (navigation: NavSection[]): string[] => {
  const urls: string[] = [];
 ...
 */
export const getPermissionSummary = (navigation: NavSection[]) => {
  const summary = {
