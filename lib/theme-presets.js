export const themePresets = {
  ...
  royal: {
    name: "Royal Grey",
    description:
      "Clean and professional default theme using the latest refined blue-gray palette.",
    category: "Professional",
    light: {
      background: "0 0% 100%",
    ...
    shadows: {
      ...
      "shadow-xs": "0px 1px 3px 0px hsl(0 0% 0% / 0.03)",
      "shadow-sm": "0px 2px 4px -1px hsl(0 0% 0% / 0.04)",
      shadow: "0px 4px 6px -1px hsl(0 0% 0% / 0.05)",
      "shadow-md": "0px 6px 8px -2px hsl(0 0% 0% / 0.06)",
      "shadow-lg": "0px 10px 15px -3px hsl(0 0% 0% / 0.08)",
      "shadow-xl": "0px 20px 25px -5px hsl(0 0% 0% / 0.1)",
